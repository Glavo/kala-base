...
public final class Tuple5<@Covariant T1, @Covariant T2, @Covariant T3, @Covariant T4, @Covariant T5>
    ...
    public static <T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> narrow(
            HList<? extends T1, ? extends HList<? extends T2, ? extends HList<? extends T3, ? extends HList<? extends T4, ? extends HList<? extends T5, ? extends EmptyTuple>>>>> tuple) {
    ...
    @NotNull
    @Override
    public final Tuple4<T2, T3, T4, T5> tail() {
    ...
    @Contract("_ -> new")
    @Override
    public final <H> Tuple6<H, T1, T2, T3, T4, T5> cons(H head) {
