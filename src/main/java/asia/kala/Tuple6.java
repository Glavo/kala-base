...
public final class Tuple6<@Covariant T1, @Covariant T2, @Covariant T3, @Covariant T4, @Covariant T5, @Covariant T6>
    ...
    public static <T1, T2, T3, T4, T5, T6> Tuple6<T1, T2, T3, T4, T5, T6> narrow(
            HList<? extends T1, ? extends HList<? extends T2, ? extends HList<? extends T3, ? extends HList<? extends T4, ? extends HList<? extends T5, ? extends HList<? extends T6, ? extends EmptyTuple>>>>>> tuple) {
    ...
    @NotNull
    @Override
    public final Tuple5<T2, T3, T4, T5, T6> tail() {
    ...
    @Contract("_ -> new")
    @Override
    public final <H> Tuple7<H, T1, T2, T3, T4, T5, T6> cons(H head) {
