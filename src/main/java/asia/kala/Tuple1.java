 ...
 * @author Glavo
 */
public final class Tuple1<@Covariant T1> extends HList<T1, EmptyTuple> implements Mappable<T1>, Serializable {
    ...
    public static <T1> Tuple1<T1> narrow(HList<? extends T1, ? extends EmptyTuple> tuple) {
